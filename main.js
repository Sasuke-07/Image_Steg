...
window.onload = function() {
    ...
    // show encode section
    document.getElementById('showEncode').addEventListener('click', function() {
        document.getElementById('options').classList.add('hide');
        document.getElementById('encodeSection').classList.remove('hide');
        document.getElementById('decodeSection').classList.add('hide');
    });

    // show decode section
    document.getElementById('showDecode').addEventListener('click', function() {
        document.getElementById('options').classList.add('hide');
        document.getElementById('decodeSection').classList.remove('hide');
        document.getElementById('encodeSection').classList.add('hide');
    });
...
var encode = function() {
    ...
    //hides the encode section after the button is clicked 
    document.getElementById('encodeSection').classList.add('hide');
